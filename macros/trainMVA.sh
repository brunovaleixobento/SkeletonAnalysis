...
if [[ -f ${SIGNAL} && -f ${BACKGROUND} ]] ; then
  ...
  applyMVA --inputdirectory ~cbeiraod/local-area/Stop4Body/AllDouble/ --outputdirectory /home/t3cms/brucms16/CMSSW_8_0_14/src/UserCode/SkeletonAnalysis/macros/bdtFiles/PCABaseSETDBkgd_Jet1Eta/
